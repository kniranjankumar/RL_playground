...
class DartBlockPushEnvAct2Body3Wrapped(DartBlockPushEnvAct2Body3):
    def __init__(self):
        self.obs_history = []
        self.act_history = []
        super().__init__()
        ...
        self.model = CnnModel(num_steps=self.num_steps,mass_dim=self.num_bodies, act_dim=2)
    ...
    def _step(self, a):
        ...
        if self.init is None:
            ...
            path = os.path.join(os.getcwd(),
                                '/home/niranjan/Projects/vis_inst/DartEnv2/examples/agents/mass_prediction_nbody/model_ckpt/_try_2/698/698.ckpt')
