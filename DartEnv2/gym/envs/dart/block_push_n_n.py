...
class DartBlockPushEnvActnBodyn(dart_env.DartEnv, utils.EzPickle):
    def __init__(self):
        ...
        self.action_scale = np.array([1000, 1.5, 0.005])
    ...
    def do_simulation(self, tau, n_frames):
        ...
        # print(tau)
        bod1.add_ext_force(np.array([tau[0] * np.sin(tau[1]), 0, tau[0] * np.cos(tau[1])]), np.array([tau[2], 0, 0]))
