...
#                         obs_act_embedding = obs_act
                        obs_act_embedding1 = slim.fully_connected(obs_act,128,scope='input_embedding1')
                        #obs_act_embedding = slim.fully_connected(obs_act_embedding1,128,scope='input_embedding')    
                        obs_act_embedding = tf.reshape(obs_act_embedding1,[self.num_steps,-1,128])
...
if arguments['only_test']:
    ...
    model = PPO2(MlpLstmPolicy, env, verbose=1, learning_rate=arguments['PPO_learning_rate'], tensorboard_log=policy_tensorboard_path, num_eps_steps=arguments['num_tries']+1)
